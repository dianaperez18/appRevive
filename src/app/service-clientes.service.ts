...
export class ServiceClientesService {
  ...
  cargarClientes() {
    this.http.get('http://192.168.2.210:8080/revive/webresources/co.edu.revive.entidades.clientes')
    .subscribe(data => {
  ...
  crearCliente(clientes: Clientes){
    ...
    this.http.post('http://192.168.2.210:8080/revive/webresources/co.edu.revive.entidades.clientes', body)
    .subscribe(data =>{
