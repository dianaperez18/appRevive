...
export class ServiceInstructoresService {
  ...
  cargarInstructores() {
    this.http.get('http://192.168.2.210:8080/revive/webresources/co.edu.revive.entidades.instructores')
    .subscribe(data => {
...
crearInstructores(instructores: Instructores){
  ...
  this.http.post('http://192.168.2.210:8080/revive/webresources/co.edu.revive.entidades.instructores', body)
  .subscribe(data =>{
